...
device_system_text.innerHTML=deviceSystem;
device_system.appendChild(device_system_text);
var device_system_icon=document.createElement("i");
device_system_icon.className="mdui-icon material-icons";
device_system_icon.innerHTML="computer";
device_system_text.appendChild(device_system_icon);
...
app_Language_text.innerHTML=appLanguage;
app_Language.appendChild(app_Language_text);
var app_Language_icon=document.createElement("i");
app_Language_icon.className="mdui-icon material-icons";
app_Language_icon.innerHTML="language";
app_Language_text.appendChild(app_Language_icon);
...
latest_version_text.innerHTML=latestVersion;
latest_version.appendChild(latest_version_text);
var latest_version_icon=document.createElement("i");
latest_version_icon.className="mdui-icon material-icons";
latest_version_icon.innerHTML="update";
latest_version_text.appendChild(latest_version_icon);
...
is_to_crack_text.innerHTML=toCrack;
is_to_crack.appendChild(is_to_crack_text);
var is_to_crack_icon=document.createElement("i");
is_to_crack_icon.className="mdui-icon material-icons";
is_to_crack_icon.innerHTML=isCrackicon;
is_to_crack_text.appendChild(is_to_crack_icon);
...
lastUpdate_time_text.innerHTML=lastUpdatetime;
lastUpdate_time.appendChild(lastUpdate_time_text);
var lastUpdate_time_icon=document.createElement("i");
lastUpdate_time_icon.className="mdui-icon material-icons";
lastUpdate_time_icon.innerHTML="access_time";
lastUpdate_time_text.appendChild(lastUpdate_time_icon);
...
function addPanelList(divID, appVersion, winDownloadUrl, winDownloadMa, winCrackDownloadUrl, winCrackDownloadMa, macDownloadUrl, macDownloadMa, macCrackDownloadUrl, macCrackDownloadMa, downloadMenuID) {
    ...
    var windows_icon=document.createElement("i");
    windows_icon.className="mdui-menu-item-icon mdui-icon material-icons";
    windows_icon.innerHTML="file_download";
    windows.appendChild(windows_icon);
    ...
    win_backup.innerHTML="Win Backup";
    ...
    var win_backup_icon=document.createElement("i");
    win_backup_icon.className="mdui-menu-item-icon mdui-icon material-icons";
    win_backup_icon.innerHTML="file_download";
    win_backup.appendChild(win_backup_icon);
    ...
    mac_os.innerHTML="Mac OS";
    mac_os.setAttribute("onclick","showWarnDialog('"+macDownloadUrl+"','"+macDownloadMa+"');");
    mdui_menu_item3.appendChild(mac_os);
    var mac_os_icon=document.createElement("i");
    mac_os_icon.className="mdui-menu-item-icon mdui-icon material-icons";
    mac_os_icon.innerHTML="file_download";
    mac_os.appendChild(mac_os_icon);
    ...
    mac_backup.innerHTML="Mac Backup";
    ...
    var mac_backup_icon=document.createElement("i");
    mac_backup_icon.className="mdui-menu-item-icon mdui-icon material-icons";
    mac_backup_icon.innerHTML="file_download";
    mac_backup.appendChild(mac_backup_icon);
}
