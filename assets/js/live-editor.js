var LiveEditor = (function() {
    ...
    LiveEditor.prototype.resizePanel = function(Top) {
        ...
        $.each(dom.editorContainers,
        function(i, editorContainer) {
    ...
    LiveEditor.prototype._setEditorWidth = function(width) {
        dom.editorContainerHTML.style.width = dom.editorContainerCSS.style.width = dom.editorContainerJS.style.width = width;
    };
